...
<html>
    ...
    <div id="uploadTitle"><div id="titleText">File Hub</div></div>
    <div id="introText">Welcome to the file hub. Here you can upload and download your files. To upload a file, just
        drag and drop it into the box below or click inside the box to open an upload dialog. But be careful, once a
        file has been added to the box it will be uploaded, no going back! To download a file, just click on the desired
        file.
    </div>
    <div id="toolbar">
        ...
        <div id="editButton"><div id="editText">Edit</div></div>
        <div id="newFolderButton"><div id="newFolderText">New Folder</div></div>
        <input type="text" name="newFolderTextInput" id="newFolderTextInput">
        <div id="seperator"></div>
    </div>
    <form action="uploadHandler.php" id="fileBox" class="dropzone"></form>
    <div id="statusBar">
        <div id="statusDiv">
