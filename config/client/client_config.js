...
gOptions = {
    ...
    maxFiles: 1000,         //*
    parallelUploads: 10,  //*
    resumableUpload: false   //*, Set to true if resumable uploads should be used. If your browser does not support it,
    // you can disable the resumable upload by setting it to false.
};