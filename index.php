...
?>
    ...
    <input type="password" name="passwordBox" placeholder="Password" id="passwordBox">
    <div id="enterButton">
        <div id="buttonText">Enter</div>
    </div>
